...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto bg-black py-8'>
        <div className='col-span-1 my-auto mx-auto w-[300px] h-auto lg:w-[400px] ml-3'>
        ...
        <div className='col-span-2 px-5 my-auto'>
            ...
            <div className='my-8'>
                ...
                <a className='px-6 py-3 w-full rounded-xl border border-gray-400 hover:bg-gradient-to-br from-orange-500 to-pink-500 text-white hover:border-none' href='#contact'>Contact</a>
